...
public class GgamfApiControllerTest extends DummyEntity {
        ...
        public void deleteGgamf_test() throws Exception {
                ...
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.nickname").value("벌써포기하는거냐"));
        }
        ...
        public void rejectGgamf_test() throws Exception {
                ...
                // then
                resultActions.andExpect(MockMvcResultMatchers.status().isOk());
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.nickname").value("행날"));
        }
        ...
        public void cancelGgamf_test() throws Exception {
                ...
                // then
                resultActions.andExpect(MockMvcResultMatchers.status().isOk());
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.nickname").value("우리팀아힘좀내봐"));
        }
        ...
        public void findGgamfList_test() throws Exception {
                ...
                resultActions.andExpect(
                                MockMvcResultMatchers.jsonPath("$.data.friendList.[0].nickname").value("CoolCat"));
        }
        ...
        public void sendGgamfList_test() throws Exception {
                ...
                resultActions.andExpect(MockMvcResultMatchers.status().isOk());
                resultActions.andExpect(
                                MockMvcResultMatchers.jsonPath("$.data.followings.[0].nickname").value("티모밴하면던짐"));
        }
        ...
        public void receiveGgamfList_test() throws Exception {
                ...
                resultActions.andExpect(MockMvcResultMatchers.status().isOk());
                resultActions.andExpect(
                                MockMvcResultMatchers.jsonPath("$.data.followers.[0].nickname").value("소나없는소나원챔"));
        }
        ...
        public void recommendBan_test() throws Exception {
                ...
                // then
                resultActions.andExpect(MockMvcResultMatchers.status().isCreated());
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.nickname").value("아맞다퇴사"));
        }
