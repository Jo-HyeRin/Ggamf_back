...
public class PartyApiControllerTest extends DummyEntity {
        ...
        public void createRoomView_test() throws Exception {
                ...
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.[1].gameName").value("LeagueOfLegend"));
        }
        ...
        public void joinRoom_test() throws Exception {
                ...
                // then
                resultActions.andExpect(MockMvcResultMatchers.status().isCreated());
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.userNick").value("그만둬 베이가"));
        }
        ...
        public void endRoom_test() throws Exception {
                ...
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.enters[0].userNick").value("티모밴하면던짐"));
        }
        ...
        public void kickUser_test() throws Exception {
                ...
                kickUserReqDto.setKickUserId(6L);
                ...
                // then
                resultActions.andExpect(MockMvcResultMatchers.status().isOk());
                resultActions.andExpect(MockMvcResultMatchers.jsonPath("$.data.userNick").value("벌써포기하는거냐"));
        }
