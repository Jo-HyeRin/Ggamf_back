...
public class DevInit extends DummyEntity {
    ...
    public CommandLineRunner dataSetting(UserRepository userRepository,
        ...
        return (args) -> {
            ...
            // Follow follow2 = followRepository.save(newFollow(cos, kaka, false));
            // Follow follow3 = followRepository.save(newFollow(dada, cos, false));
            // Follow follow4 = followRepository.save(newFollow(nana, cos, false));
            // Follow friend5 = followRepository.save(newFriend(cos, vovo, true));
            // Follow friend6 = followRepository.save(newFriend(toto, cos, true));
            // ReasonCode : 신고카테고리
